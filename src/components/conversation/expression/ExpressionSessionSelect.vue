<template>
  <div class="bg-gradient-to-br from-gray-50 to-white rounded-3xl border border-white/60 shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-8 overflow-hidden relative min-h-[700px] flex flex-col">
    <!-- Header -->
    ...
    <!-- Circular Gallery Container - 왼쪽으로 오프셋하여 반원 전체 보이게 -->
    <div class="flex-1 w-full relative" style="height: 550px; margin-left: -180px; width: calc(100% + 300px);">
      <CircularGallery
        :items="sessions"
        :bend="-100"
        :borderRadius="0.05"
      ...
      >
        <template #default="{ item: session, index: idx, isActive }">
          <!-- Card Content -->
          <div class="w-[420px] h-[520px] bg-white rounded-3xl border border-white/80 shadow-[0_8px_30px_rgba(0,0,0,0.08)] p-8 flex flex-col relative overflow-hidden transition-all duration-300 hover:border-blue-200"
