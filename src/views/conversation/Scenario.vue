  ...
  <div class="h-full flex flex-col relative">
    ...
    <div class="absolute top-0 left-0 right-0 h-20 bg-white/80 backdrop-blur-sm z-20 flex items-center justify-between px-4 md:px-8 border-b border-gray-100">
      <div class="flex items-center gap-4">
        ...
        <span class="bg-blue-100 text-blue-600 px-3 py-1 rounded-full text-xs font-bold shrink-0">{{ scenarios.length }}</span>
      </div>
        ...
        <template v-else-if="scenarios.length > 0">
          ...
          <div class="md:hidden h-full flex flex-col">
            ...
            <div class="mb-6 relative z-30">
              <button 
                @click="mobileShowProjects = !mobileShowProjects"
              ...
              >
                <div class="p-2 max-h-60 overflow-y-auto">
                  <button
                    @click="selectedProjects = []; mobileShowProjects = false; loadScenariosForFilters()"
