<template>
  <div class="p-2 md:p-4 max-w-[95%] mx-auto h-full">
    <div class="bg-white/85 backdrop-blur-xl rounded-[2.5rem] shadow-2xl p-8 min-h-[90vh] border border-white/50">
    ...
    <div v-if="currentView !== 'selection'" class="mb-6">
      ...
      <div v-if="currentView === 'practice' || currentView === 'quiz'" class="flex items-center gap-4">
        <div class="flex items-center gap-2">
          ...
          <span class="font-medium" :class="currentView === 'practice' ? 'text-blue-600' : 'text-green-600'">발음 연습</span>
        </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <span class="font-medium" :class="currentView === 'quiz' ? 'text-blue-600' : 'text-gray-500'">퀴즈</span>
        </div>
      </div>
    ...
    <div v-if="currentView === 'selection'">
      ...
      <div class="mb-6 bg-white/60 backdrop-blur-md rounded-3xl shadow-lg border border-white/50 p-6">
        <div class="flex items-center gap-2 mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            ...
            class="p-6 rounded-3xl border-2 transition-all duration-200 text-left"
            :class="selectedUnit === unit.unit
              ? 'bg-blue-50/80 border-blue-600 shadow-md'
              : 'bg-white/50 border-white/60 hover:border-blue-300 hover:shadow-lg hover:bg-white/80'"
          >
      ...
      <div v-if="selectedUnit && chapters.length > 0" class="mb-6 bg-white/60 backdrop-blur-md rounded-3xl shadow-lg border border-white/50 p-6">
        <div class="flex items-center gap-2 mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            ...
            class="p-4 rounded-3xl border-2 transition-all duration-200 text-left hover:border-blue-300 hover:shadow-lg hover:bg-white/80 bg-white/50 border-white/60"
          >
            <div class="flex justify-between items-start">
              <div>
    ...
    <div v-else-if="currentView === 'sessionSelect'" class="space-y-6">
      <div class="bg-white/60 backdrop-blur-md rounded-3xl shadow-lg border border-white/50 p-6">
          ...
          >
            <div class="flex justify-between items-start mb-3">
              <div class="flex items-center gap-2">
                <span
                  ...
                  :class="session.completed ? 'bg-green-500 text-white' : 'bg-blue-100 text-blue-600'"
                >
            ...
            <div class="mt-4 pt-3 border-t">
              <span
                ...
                :class="session.completed ? 'text-green-600' : 'text-blue-600'"
              >
    ...
    <div v-else-if="currentView === 'practice'" class="space-y-6">
      <div class="bg-white/60 backdrop-blur-md rounded-3xl shadow-lg border border-white/50 p-6">
        ...
        <div class="flex justify-between items-center mb-4">
          ...
          <div class="flex gap-2">
            <button
              ...
              class="p-2 rounded-full border border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <ChevronLeftIcon class="w-5 h-5" />
            </button>
            <button
        ...
        <!-- Expression Summary -->
        <div class="bg-gray-50 border-l-4 border-blue-600 rounded-r-3xl p-4 mb-6">
        ...
        <div v-if="currentExpression.examples && currentExpression.examples.length > 0">
          ...
          <div class="space-y-4">
            <div
              ...
              :key="idx"
              class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-3xl p-5 border border-blue-200"
            >
              <div class="mb-4">
              ...
              <div class="flex gap-3">
                <button
                  ...
                  :disabled="ttsLoading"
                  class="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition disabled:opacity-50"
                >
                ...
                <button
                  ...
                  class="flex items-center gap-2 px-4 py-2 bg-white text-blue-600 border border-blue-200 rounded-full hover:bg-blue-50 transition disabled:opacity-50"
                >
        ...
        <div class="mt-6 pt-6 border-t">
          ...
          <button
            ...
            @click="goToQuiz"
            class="w-full py-3 rounded-full bg-green-500 text-white hover:bg-green-600 transition flex items-center justify-center gap-2"
          >
    ...
    <div v-else-if="currentView === 'quiz'" class="space-y-6">
      <div class="bg-white/60 backdrop-blur-md rounded-3xl shadow-lg border border-white/50 p-6">
        ...
        <div v-if="currentQuizQuestion" class="mb-6">
          <div class="bg-blue-50 rounded-3xl p-6 mb-4">
          ...
          <div class="mb-4">
            <input
              ...
              class="w-full px-4 py-3 border-2 rounded-3xl focus:outline-none focus:border-blue-600 text-lg"
              :class="{
          ...
          <!-- Answer Feedback -->
          <div v-if="answerStatus === 'correct'" class="mb-4 p-4 bg-green-100 rounded-3xl">
            <p class="text-green-700 font-semibold flex items-center gap-2">
              <CheckCircleIcon class="w-5 h-5" />
              정답입니다!
            </p>
          </div>
          <div v-else-if="answerStatus === 'wrong'" class="mb-4 p-4 bg-red-100 rounded-3xl">
          ...
          <div class="flex gap-3">
            <button
              ...
              class="flex-1 py-3 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              정답 확인
            </button>
            <button
              ...
              @click="nextQuiz"
              class="flex-1 py-3 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition"
            >
              다음 문제
            </button>
            <button
              ...
              class="flex-1 py-3 rounded-full bg-green-500 text-white hover:bg-green-600 transition flex items-center justify-center gap-2"
            >
    ...
    >
      <div class="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl text-center">
        ...
        <div class="bg-gray-50 rounded-3xl p-4 mb-6">
          <div class="grid grid-cols-2 gap-4">
            <div>
              <p class="text-sm text-gray-500">퀴즈 점수</p>
              <p class="text-2xl font-bold text-blue-600">{{ quizCorrectCount }} / {{ quizQuestions.length }}</p>
            </div>
            <div>
        ...
        <div class="space-y-3">
          <button
            ...
            class="w-full py-3 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition"
          >
            다음 세션으로 (세션 {{ currentSessionIndex + 2 }})
          </button>
          <button
            @click="goBackToSessionSelect"
            class="w-full py-3 rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300 transition"
          >
            세션 선택으로 돌아가기
          </button>
        </div>
    ...
    >
      <div class="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <!-- Reference Text -->
        <div class="bg-blue-50 rounded-3xl p-4 mb-6">>
        ...
        <div class="flex justify-center gap-4 mb-6">
          <button
            ...
            class="px-6 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition flex items-center gap-2"
          >
            <MicrophoneIcon class="w-5 h-5" />
            녹음 시작
          </button>
          <button
            v-else
            @click="stopRecording"
            class="px-6 py-3 bg-red-500 text-white rounded-full hover:bg-red-600 transition flex items-center gap-2"
          >
        ...
        <div v-if="pronunciationResult" class="border-t pt-6">
          ...
          <div class="grid grid-cols-2 gap-3 mb-4">
            <div class="bg-blue-50 rounded-3xl p-3 text-center">
            ...
            <div class="bg-green-50 rounded-3xl p-3 text-center">
            ...
            <div class="bg-purple-50 rounded-3xl p-3 text-center">
            ...
            <div class="bg-yellow-50 rounded-3xl p-3 text-center">
